...
if __name__ == '__main__':
    ...
    dataset = NetsDataset(nets_dir='../TrainingData/test/', img_dir=None)
    ...
    #
    # verts, faces, normals, values = measure.marching_cubes(real_batch.numpy()[0][0], isosurface_value)
    # # Plot isosurface
