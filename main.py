...
class NetsDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # return image, label
        nets = np.loadtxt(nets_path).astype('float16')
        assert len(nets) == 32 * 32 * 32, "nets shape not on 32 * 32 * 32"
        nets_pt = torch.from_numpy(nets).reshape((32, 32, 32))
        return nets_pt
...
if __name__ == '__main__':
    ...
    # Create the dataset
    dataset = NetsDataset(nets_dir='/Users/pengyuchen/Documents/Work/NETs_dataset', img_dir=None)
