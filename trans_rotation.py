...
path = '/Users/pengyuchen/Documents/Work/NETs_dataset'
outpath = '/Users/pengyuchen/Documents/Work/NETs_dataset_translated'
for file in os.listdir(path):
    if file.endswith('.txt'):
        ...
        v1 = v1.reshape(-1)
        np.savetxt(os.path.join(outpath,file),v1)
